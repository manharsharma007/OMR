...
namespace careeracademyapp {
    ...
    public partial class databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class templateDataTable : global::System.Data.TypedTableBase<templateRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public templateRow AddtemplateRow(string template_name) {
...
namespace careeracademyapp.databaseDataSetTableAdapters {
    ...
    public partial class templateTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[template] ([template_name]) VALUES (@template_name);\r\nSELECT t" +
                "emplate_id, template_name FROM template WHERE (template_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[template] SET [template_name] = @template_name WHERE (([template_id" +
                "] = @Original_template_id) AND ([template_name] = @Original_template_name));\r\nSE" +
                "LECT template_id, template_name FROM template WHERE (template_id = @template_id)" +
                "";
        ...
        public virtual int Insert(string template_name) {
        ...
        public virtual int Update(string template_name, int Original_template_id, string Original_template_name, int template_id) {
            if ((template_name == null)) {
                throw new global::System.ArgumentNullException("template_name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_template_id));
            if ((Original_template_name == null)) {
                throw new global::System.ArgumentNullException("Original_template_name");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_template_name));
            }
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(template_id));
        ...
        public virtual int Update(string template_name, int Original_template_id, string Original_template_name) {
            return this.Update(template_name, Original_template_id, Original_template_name, Original_template_id);
        }
    }
