...
{
    public partial class SubSheetProcessor : Form
    {
        ...
        {
            SubSheetDesigner sheet = new SubSheetDesigner();
            sheet.ShowDialog();
        }

        private void SubSheetProcessor_Load(object sender, EventArgs e)
        {
            DataTable ds = data.select_custom_template();
            ...
            dt.Columns.Add("MARKS/Questions");
        ...
        {
            SubAnswerSheet answersheet = new SubAnswerSheet();
        ...
        private void SubSheetProcessor_Activated(object sender, EventArgs e)
        {
...
MessageBoxDefaultButton.Button1);
        ...
        private void process_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                options = data.select_batch_custom_options_all(batch_id);
   ...
   MessageBoxDefaultButton.Button1);
    ...
    MessageBoxDefaultButton.Button1);
        ...
        private void findresult()
        {
            for (int index = 0; index < options.Rows.Count; index++)
            {
                ...
                string marks = Convert.ToString(options.Rows[index]["option_marks"]);

                string[] s = marks.Split(',');
                double[] marks_arr;
                if(s.Length < 6)
                {
                    marks_arr = new double[6] { 1.00, 2.00, 3.00, 4.00, 5.00, 0.5 };
                }
                else
                {
                    marks_arr = Array.ConvertAll(s, double.Parse);
                }
        ...
        */
        private void SubSheetProcessor_FormClosing(object sender, FormClosingEventArgs e)
        {
            if(th != null)
        ...
        private void save_result_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                data.save_custom_test(batch_id, save_result_txt.Text, dt);
                dt.Clear();
    ...
    MessageBoxDefaultButton.Button1);
        ...
        {
            SubReports reports = new SubReports();
            reports.Show();
        }
    ...
    MessageBoxDefaultButton.Button1);
        ...
        {
            SubUpdateBatch obj = new SubUpdateBatch();
            obj.ShowDialog();
        }
...
MessageBoxDefaultButton.Button1);
        ...
        {
            omrapplication.Main.help obj = new Main.help();
            obj.ShowDialog();
        }
